...
class Settings(BaseSettings):
    ...
    model_backend: Literal["auto", "openvino", "pytorch"] = Field(default="auto", env="MODEL_BACKEND")
    ...
    openvino_performance_mode: Literal["LATENCY", "THROUGHPUT", "CUMULATIVE_THROUGHPUT"] = Field(
        default="LATENCY", env="OPENVINO_PERFORMANCE_MODE"
    )
    ...
    min_confidence_for_report: float = Field(default=0.6, env="MIN_CONFIDENCE_FOR_REPORT")
    tracking_distance_threshold: int = Field(default=50, env="TRACKING_DISTANCE_THRESHOLD")
    ...
    railway_environment_name: Optional[str] = Field(default=None, env="RAILWAY_ENVIRONMENT_NAME")
