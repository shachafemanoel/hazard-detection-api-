...
class TestPerformanceMonitor:
    ...
    def test_record_inference(self):
        ...
        openvino_metrics = [m for m in monitor.inference_metrics if m["backend"] == "openvino"]
        pytorch_metrics = [m for m in monitor.inference_metrics if m["backend"] == "pytorch"]
    ...
    def test_get_inference_stats(self):
        ...
        assert stats["avg_inference_time"] == 0.05875  # (0.05 + 0.08 + 0.045 + 0.06) / 4
