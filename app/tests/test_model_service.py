...
class TestModelService:
    ...
    async def test_load_model_all_failed(self):
        ...
        with patch('app.services.model_service.ov', None), \
    ...
    async def test_predict_pytorch_success(self):
        ...
        with patch('app.services.model_service.model_config') as mock_config:
            mock_config.class_names = ["Alligator Crack", "Block Crack", "Crosswalk Blur", "Lane Blur",
    ...
    def test_apply_nms(self):
        ...
        detections = [
            ...
            DetectionResult([150, 150, 250, 250], 0.8, 0, "Class1"),  # Overlaps with first
            DetectionResult([300, 300, 400, 400], 0.7, 1, "Class2"),  # Different location
        ]
